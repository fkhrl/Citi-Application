    ...
    <body class="">
        ...
        <div id="content">
          ...
          <div class="innerAll spacing-x2">
                <div class="col-sm-12" id="slider_57"></div>
            </div>
        </div>
        <!-- // Slider END -->
                    ...
                    var dataSource = new kendo.data.DataSource({
                        ...
                        schema: {
                            ...
                            model: {
                                id: "id",
                                fields: {
                                    id: {nullable: true},name: {type: "string"},image: {type: "string"},
									date: {type: "string"}
                                }
                            }
                        }
                    });
                    jQuery("#slider_57").kendoGrid({
                        ...
                        sortable: true,
                        groupable: true,
                        columns: [{field: "id", title: "#"},{field: "name", title: "Name"},{field: "image", title: "Image"},
