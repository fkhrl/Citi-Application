    ...
    <body class="">
        ...
        <div id="content">
          ...
          <div class="innerAll spacing-x2">
                <div class="col-sm-12" id="welcome_content_60"></div>
            </div>
        </div>
        <!-- // Welcome Content END -->
                    ...
                    var dataSource = new kendo.data.DataSource({
                        ...
                        schema: {
                            ...
                            model: {
                                id: "id",
                                fields: {
                                    id: {nullable: true},name: {type: "string"},details: {type: "string"},author: {type: "string"},
									date: {type: "string"}
                                }
                            }
                        }
                    });
                    jQuery("#welcome_content_60").kendoGrid({
                        ...
                        sortable: true,
                        groupable: true,
                        columns: [{field: "id", title: "#"},{field: "name", title: "Name"},{field: "details", title: "Details"},{field: "author", title: "Author"},
